...
public/projects/project1.png → used in the Projects component
Usage in components: <img src="/profile.jpg" alt="My Profile" />


## Getting Started
1. Clone the repository :
git clone https://github.com/Majhadi-Mohamed/My-New-Portfolio.git
cd My-New-Portfolio
